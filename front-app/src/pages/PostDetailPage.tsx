...
export default function PostDetailPage() {
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden pb-24 max-w-[480px] mx-auto">
      {/* Top App Bar */}
      ...
      {/* Sticky Bottom CTA */}
      <div className="fixed bottom-0 left-1/2 -translate-x-1/2 z-40 w-full max-w-[480px] bg-gradient-to-t from-white via-white to-transparent pt-8">
