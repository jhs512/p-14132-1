...
function isDefaultThumbnail(url: string | undefined): boolean {
  if (!url) return true;
  return (
    url.includes("/images/post-default-thumbnail") || url.startsWith("/images/")
  );
}
            ...
            <li key={post.id}>
              <Link href={`/p/${post.id}`}>
                <Card className="hover:bg-accent/50 transition-colors">
                  ...
                  <CardContent>
                    <div className="mb-4">
                      {isDefaultThumbnail(post.thumbnailImgUrl) ? (
                        ...
                        <Image
                          src={getImageUrl(post.thumbnailImgUrl)}
                          alt={post.title}
                          width={400}
                          height={400}
